...
export const searchBottomSheetCrud: Crud = {
    identifier: "searchBottomSheetCrud",
    header: {
        title: "Manage User",
    ...
    search: {
        displayType: SearchDisplayType.BOTTOM_MODAL,
        form: {
                ...
                widgets: [
                    {
                        ...
                        widget: {
                            ...
                            actions: [
                                {
                                    ...
                                    onlyIcon: false,
                                    confirmationConfiguration: {
                                        identifier: "deleteUserAddressCnfDialog",
                                        title: "Confirm Delete",
                                        message: "Do you want to delete User Address - '{firstName} {middleName} {lastName}'?",
                                        width: "350",
                                        buttons: [
                                            {
                                                identifier: "cancelDeleteUserAddress",
                                                color: ButtonColor.DEFAULT,
                                                size: ButtonSize.SMALL,
                                                type: ButtonType.STROKED,
                                                icon: "close",
                                            ...
                                            {
                                                identifier: "deleteUserAddressConfirm",
                                                color: ButtonColor.WARN,
                                                size: ButtonSize.SMALL,
                                                type: ButtonType.FLAT,
                                                icon: "delete",
                            ...
                            noRecordFound: "No user address found",
                            hasColumnSelection: false,
