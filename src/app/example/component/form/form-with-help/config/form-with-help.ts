import { Form, FormDiaplyMode, FormHelpPosition, FormTitleIconPosition, } from 'ngx-material-widget/lib/form/model';
...
export const formWithHelp: Form = {
    identifier: "formWithHelp",
    header: {
        title: "Form with help",
        subtitle: "A help icon beside the form title is configured to display any help message related to the form",
        icon: {
