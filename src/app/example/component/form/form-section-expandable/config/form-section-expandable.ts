import { Form, FormDiaplyMode, FormSectionExpand, FormTitleIconPosition, } from 'ngx-material-widget/lib/form/model';
...
export const formSectionExpandable: Form = {
    identifier: "formSectionExpandable",
    header: {
        title: "Form Section Expandable",
        icon: {
            font: "vertical_split",
    ...
    formFields: [
        ...
        },
        {
            ...
            separator: {
                ...
                expandable: {
                    allowed: true,
                    default: FormSectionExpand.EXPAND
                },
                beforeField: true
            },
            displayInColumns: 2
