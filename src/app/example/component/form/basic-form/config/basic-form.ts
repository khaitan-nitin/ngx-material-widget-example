...
export const basicForm: Form = {
    identifier: "basicForm",
    header: {
        title: "Basic Form",
        addModeTitle: "Add Basic Form",
        editModeTitle: "Edit Basic Form",
        viewModeTitle: "View Basic Form",
        searchModeTitle: "Search Basic Form",
        subtitle: "Example of a basic form in different modes (Add/Edit/Delete)",
        icon: {
            font: "view_module",
