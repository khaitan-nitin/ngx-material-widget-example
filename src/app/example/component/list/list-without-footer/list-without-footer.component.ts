...
import { listWithoutFooter } from './config/list-without-footer';

@Component({
  selector: 'app-list-without-footer',
  templateUrl: './list-without-footer.component.html',
  styleUrls: ['./list-without-footer.component.scss']
})
export class ListWithoutFooterComponent implements OnInit {
  listWithoutFooter: List;
  parent: ObjectTree;
  listReset: boolean;
  ...
  ngOnInit(): void {
    this.listWithoutFooter = listWithoutFooter;
  ...
  buttonClick(buttonAction: Action) {
    ...
    if (buttonAction.action == "goToGithub") {
      window.open("https://github.com/khaitan-nitin/ngx-material-widget-example/tree/main/src/app/example/component/list/list-without-card", "_blank");
    }
  }
