...
import { listAlternateRowShade } from './config/list-alternate-row-shade';

@Component({
  selector: 'app-list-alternate-row-shade',
  templateUrl: './list-alternate-row-shade.component.html',
  styleUrls: ['./list-alternate-row-shade.component.scss']
})
export class ListAlternateRowShadeComponent implements OnInit {
  listAlternateRowShade: List;
  parent: ObjectTree;
  listReset: boolean;
  ...
  ngOnInit(): void {
    this.listAlternateRowShade = listAlternateRowShade;
  ...
  buttonClick(buttonAction: Action) {
    ...
    if (buttonAction.action == "goToGithub") {
      window.open("https://github.com/khaitan-nitin/ngx-material-widget-example/tree/main/src/app/example/component/list/list-alternate-row-shade", "_blank");
    }
  }
