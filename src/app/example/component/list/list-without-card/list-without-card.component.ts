...
import { listWithoutCard } from './config/list-without-card';

@Component({
  selector: 'app-list-without-card',
  templateUrl: './list-without-card.component.html',
  styleUrls: ['./list-without-card.component.scss']
})
export class ListWithoutCardComponent implements OnInit {
  listWithoutCard: List;
  parent: ObjectTree;
  listReset: boolean;
  ...
  ngOnInit(): void {
    this.listWithoutCard = listWithoutCard;
