...
import { listDiabledRow } from './config/list-diabled-row';

@Component({
  selector: 'app-list-diabled-row',
  templateUrl: './list-diabled-row.component.html',
  styleUrls: ['./list-diabled-row.component.scss']
})
export class ListDiabledRowComponent implements OnInit {
  listDiabledRow: List;
  parent: ObjectTree;
  listReset: boolean;
  ...
  ngOnInit(): void {
    this.listDiabledRow = listDiabledRow;
  ...
  buttonClick(buttonAction: Action) {
    ...
    if (buttonAction.action == "goToGithub") {
      window.open("https://github.com/khaitan-nitin/ngx-material-widget-example/tree/main/src/app/example/component/list/list-diabled-row", "_blank");
    }
  }
