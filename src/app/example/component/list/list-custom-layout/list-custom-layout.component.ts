...
import { listCustomLayout } from './config/list-custom-layout';

@Component({
  selector: 'app-list-custom-layout',
  templateUrl: './list-custom-layout.component.html',
  styleUrls: ['./list-custom-layout.component.scss']
})
export class ListCustomLayoutComponent implements OnInit {
  listCustomLayout: List;
  parent: ObjectTree;
  listReset: boolean;
  ...
  ngOnInit(): void {
    this.listCustomLayout = listCustomLayout;
  ...
  buttonClick(buttonAction: Action) {
    ...
    if (buttonAction.action == "goToGithub") {
      window.open("https://github.com/khaitan-nitin/ngx-material-widget-example/tree/main/src/app/example/component/list/list-custom-layout", "_blank");
    }
  }
