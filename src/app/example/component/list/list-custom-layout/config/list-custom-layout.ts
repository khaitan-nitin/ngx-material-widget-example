...
export const listCustomLayout: List = {
    identifier: "listCustomLayout",
    header: {
        title: "Custom Layout",
        icon: {
            font: "lens_blur"
    ...
    description: {
        text: "Rows in a list can be displayed in the card view on the desktop and table device as well by using this configuration"
    },
    shade: {
