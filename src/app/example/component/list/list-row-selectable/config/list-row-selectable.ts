import { FieldType, FieldAppearance } from 'ngx-material-widget/lib/field/model';
...
export const listRowSelectable: List = {
    identifier: "listRowSelectable",
    header: {
        title: "Row Selector",
        icon: {
            font: "format_indent_increase"
        },
        actions: [
            {
