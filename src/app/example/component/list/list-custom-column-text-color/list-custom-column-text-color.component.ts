...
import { listCustomColumnTextColor } from './config/list-custom-column-text-color';

@Component({
  selector: 'app-list-custom-column-text-color',
  templateUrl: './list-custom-column-text-color.component.html',
  styleUrls: ['./list-custom-column-text-color.component.scss']
})
export class ListCustomColumnTextColorComponent implements OnInit {
  listCustomColumnTextColor: List;
  parent: ObjectTree;
  listReset: boolean;
  ...
  ngOnInit(): void {
    this.listCustomColumnTextColor = listCustomColumnTextColor;
  ...
  buttonClick(buttonAction: Action) {
    ...
    if (buttonAction.action == "goToGithub") {
      window.open("https://github.com/khaitan-nitin/ngx-material-widget-example/tree/main/src/app/example/component/list/list-custom-column-text-color", "_blank");
    }
  }
