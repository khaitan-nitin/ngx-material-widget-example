...
export const listCustomColumnTextColor: List = {
    identifier: "listCustomColumnTextColor",
    header: {
        title: "Column text color",
        icon: {
            font: "margin"
        },
        actions: [
    ...
    columns: [
        {
            ...
            textColor: (record) => {
                var color = "";
                if (record['firstName'].length > 5)   {
                    console.log(record['firstName'].length);
                    color = "#ef6f6f";
                }
