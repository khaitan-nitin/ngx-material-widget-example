...
export const listWithColumnSort: List = {
    identifier: "listWithColumnSort",
    header: {
        title: "Customize sorting",
        icon: {
            font: "sort_by_alpha"
        },
        actions: [
    ...
    description: {
        text: "This module has a default sort configured on First Name. Also, it configured so that user can sort on name, email and dob.",
        bgColor: "#e6ebf9"
    },
    shade: {
